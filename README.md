...
- [Hash table](practice/cpp/hash_table)
  ...
  - Array nesting - [python](practice/python/hash_table/array_nesting.py)
- Linked list
...
- [Binary search tree](practice/cpp/binary_search_tree)
  ...
  - Unique binary search tree II - [python](practice/python/binary_search_tree/unique_binary_search_trees_2.py)
- Graph
